...
void main() {
  ...
  // 평균 값
  // int/double 일 때(num 타입) 나누게 되면, double 타입 결과물
  ...
  print('multiples.last : ${multiples.last}');
  ...
  for (int i = 0; i < 20; i++) {
    ...
    // multiples[i] = i * N;
    multiples.add(i * N); // 0 8 16 24 32 40 48 56 64 72 80 88 96 104 112 120 128 136 144 152
  ...
  // 일반적인 다른 언어의 방법
  for (int i = 0; i < multiples.length; i++) {
    print("multiples[${i}] 출력 : ${multiples[i]} ");
  }
  print('multiples.last : ${multiples.last}');
