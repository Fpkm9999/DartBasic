...
void greet2(String name, [String? suffix]) {
  if (suffix != null) {
...
void greet3({String? name, String? suffix}) {
  if (name != null) {
    print('Hello, $name ${suffix ?? ''}');
  }
}
...
//
// Dart 2.12부터는 required 키워드를 사용하여 이름 있는 파라미터를 필수로 만들 수 있습니다. 이렇게 하면 호출자가 해당 파라미터를 생략할 수 없습니다.
